...
// This code is copyrighted by Konrad Rudolph and published under the text of
// the Apache 2.0 license (https://github.com/klmr/cpp11-range).  It has small
// modifications Mark Harris (https://github.com/harrism/cpp11-range) which
// are release under the same license.  Any further modifications by Clark
// McGrew are release under the same license.
